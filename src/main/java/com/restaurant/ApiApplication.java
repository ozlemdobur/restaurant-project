...
public class ApiApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       Product product = new Product(null, "Meat", "gram", 1000.0,20000.0,"https://www.bol.com/nl/nl/","Dukes",20D,5D,"Food");
        Product product1 = productRepository.save(product);
        product = new Product(null, "Tomato", "gram", 10000.0, 120.0,"https://www.bol.com/nl/nl/","Ca",3D,1D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Potato", "gram", 15000.0, 120000.0,"https://www.bol.com/nl/nl/","Potat",5D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Milk", "litre", 2000.0, 120.0,"https://www.bol.com/nl/nl/","Milka",2D,2D,"Drink");
        product1 = productRepository.save(product);
        product = new Product(null, "Lettuce", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Salmon", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Carrot", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Aubergine", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Sausage", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Cheese", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Nut", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Butter", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Sugar", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Rice", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Kip", "piece", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Apple", "liter", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Orange", "liter", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Food");
        product1 = productRepository.save(product);
        product = new Product(null, "Water", "liter", 100.0, 10.0,"https://www.bol.com/nl/nl/","Groen",2D,2D,"Drink");
        product1 = productRepository.save(product);
